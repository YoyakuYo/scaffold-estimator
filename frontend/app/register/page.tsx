...
export default function RegisterPage() {
  ...
  const [companyAddress, setCompanyAddress] = useState<AddressFields>({
    postalCode: '',
    prefecture: '',
    city: '',
    town: '',
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    registerMutation.mutate({
      ...
      companyPrefecture: companyAddress.prefecture,
      companyCity: companyAddress.city,
      companyTown: companyAddress.town,
      companyAddressLine: companyAddress.addressLine,
      companyBuilding: companyAddress.building,
    });
  };

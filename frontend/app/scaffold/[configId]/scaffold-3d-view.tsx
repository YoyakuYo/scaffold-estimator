  ...
  useEffect(() => {
    ...
    import('three').then(async (THREE) => {
      ...
      function buildWallScaffold(
        ...
        // The reused corner section (first span) is rendered in cornerGroup so the wall body starts after it.
      ...
      for (let wi = 0; wi < walls.length; wi++) {
        ...
        for (let lv = 1; lv <= maxLevelsForCorners; lv++) {
          ...
          // Restore the turned first-span plank (e.g. 1800) between reused posts and wall B first new posts.
          if (!isOpenPolygon) {

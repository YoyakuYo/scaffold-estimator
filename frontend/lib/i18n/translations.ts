...
export const translations = {
  ...
  superadminConsole: {
    ...
    analyticsOperatorTitle: {
      ja: 'プラットフォーム指標',
      en: 'Platform metrics',
      fr: 'Métriques plateforme',
    },
    analyticsOperatorSubtitle: {
      ja: 'トラフィック、テナント、アップロードを一画面で確認。期間は左のトグルで変更できます。',
    ...
    analyticsRange28: { ja: '28日', en: '28 days', fr: '28 j' },
    analyticsOperatorTrafficTitle: { ja: 'トラフィックとサインイン', en: 'Traffic & sign-ins', fr: 'Trafic et connexions' },
    analyticsOperatorTrafficDesc: {
      ja: 'ページビュー（棒）と login_history に基づく同日のサインイン数（線）。',
      en: 'Bars: instrumented page views. Line: same-day authentications counted from login history.',
      fr: 'Barres : pages vues tracées. Courbe : authentifications le même jour (historique connexions).',
    },
    analyticsOperatorTrafficFootnote: {
      ja: 'トラフィック系列の長さは上記のウィンドウ（7〜28日）に一致します。',
      en: 'The traffic series spans the telemetry window shown above.',
      fr: 'La série de trafic couvre exactement la fenêtre affichée.',
    },
    analyticsOperatorRoutesTitle: { ja: '主要ルート', en: 'Top routes', fr: 'Itinéraires clés' },
    analyticsOperatorRoutesDesc: {
      ja: '{days}日間で最も読み込まれたパス。',
      en: 'Most-viewed normalized paths across the trailing {days} days.',
      fr: 'Chemins les plus vus ({days} jours).',
    },
    analyticsSortByVolume: { ja: '件数順', en: 'By volume', fr: 'Par volume' },
    analyticsSortByPath: {
      ja: 'パス名順',
      en: 'By path',
      fr: 'Par chemin',
    },
    analyticsColRoute: { ja: 'パス', en: 'Route', fr: 'Chemin' },
    analyticsColHits: { ja: 'ビュー', en: 'Views', fr: 'Vues' },
    analyticsColKind: { ja: '種類', en: 'Kind', fr: 'Type' },
    analyticsColCount: { ja: '件数', en: 'Count', fr: 'Total' },
    analyticsOperatorKindsTitle: { ja: 'アップロード種類', en: 'Upload breakdown', fr: 'Téléversements par type' },
    analyticsOperatorKindsDesc: {
      ja: '`upload_events` の kind を {days} 日間集計。',
      en: 'Counts from upload_events.kind for the selected window.',
      fr: 'Répartition depuis `upload_events.kind` ({days} j).',
    },
    analyticsOperatorUploadsPeriod: {
      ja: 'アップロード（{days}日）',
      en: 'Uploads ({days} days)',
      fr: 'Imports ({days} j)',
    },
    analyticsOperatorProductsTitle: {
      ja: 'プロダクト別',
      en: 'By workspace product',
      fr: 'Par produit workspace',
    },
    analyticsOperatorProductsDesc: {
    ...
    analyticsHudEyebrow: {
      ...
      en: 'Live telemetry terminal · platform',
      fr: 'Terminal télémétrique · plateforme',
    },
    analyticsHudTitle: {
      ja: 'プラットフォーム アナリティクス・オブザバトリー',
    ...
    analyticsHudPanelActivity: {
      ...
      fr: 'Mix télémétrique · 24h',
    },
    analyticsHudPanelActivitySub: {
      ja: 'PV・ログイン・日次平均。',
      en: 'Page traffic, authenticated sessions, trailing mean.',
      fr: 'Trafic pages, connexions, moyenne glissante.',
    },
    analyticsHudBarPvShort: { ja: 'PV・24h', en: 'PV · 24h', fr: 'PV · 24h' },
    analyticsHudBarLoginShort: { ja: 'LG・24h', en: 'Logins · 24h', fr: 'Connex. · 24h' },
    analyticsHudBarAvgShort: { ja: '日均PV', en: 'Mean/day', fr: 'Moy/j' },
    analyticsHudCount: { ja: '件数', en: 'Events', fr: 'Événements' },
    analyticsHudPanelSplit: {
      ja: '7日ボリューム配分',
      en: 'Seven-day attribution',
      fr: 'Attribution 7 jours',
    },
    analyticsHudPanelSplitSub: {
      ja: '直近24hと残りウィンドウ。',
      en: 'Rolling window split after the last solar day.',
      fr: 'Fenêtre glissante par rapport aux dernières 24 h.',
    },
    analyticsHudSlice24: { ja: '・24h', en: '24h wedge', fr: 'Tranche 24h' },
    analyticsHudSliceRest: { ja: '・残り', en: 'Balance', fr: 'Reliquat' },
    analyticsHudPanelWave: { ja: '訪問波形', en: 'Visit waveform · 14d', fr: 'Forme onde visites · 14j' },
    analyticsHudPanelSlope: {
      ja: '累積勾配',
      en: 'Cumulative slope',
      fr: 'Pente cumulée',
    },
    analyticsHudPanelSlopeSub: {
      ja: '積算上げのワークロード。',
      en: 'Stacked demand across the fortnight horizon.',
      fr: 'Charge empilée sur l’historique disponible.',
    },
    analyticsHudCumulative: { ja: '累積PV', en: 'Cumulative PV', fr: 'PV cumulés' },
    analyticsHudMeshCaption: {
      ja: 'コアメッシュ · シグナル空間',
      en: 'Core mesh · signal space',
      fr: 'Maillage central · signal',
    },
    analyticsHudMeshQuotes: { ja: '見積', en: 'Quotes', fr: 'Devis' },
    analyticsHudMeshAi: { ja: 'AI抽出', en: 'AI extract', fr: 'Extraction IA' },
    analyticsHudMeshIfc: { ja: 'IFC', en: 'IFC', fr: 'IFC' },
    analyticsHudMeshCad: { ja: 'CAD手描き', en: 'CAD sketch', fr: 'CAO dessinée' },
    analyticsHudMeshIdentity: { ja: '認証', en: 'Identity', fr: 'Identité' },
    analyticsHudMeshSubs: { ja: '課金', en: 'Billing', fr: 'Facturation' },
    analyticsHudMeshExports: { ja: 'Excel', en: 'Excel', fr: 'Excel' },
    analyticsHudRadarPv24: {
      ja: '瞬間PV',
      en: 'Burst PV',
      fr: 'Pic PV',
    },
    analyticsHudRadarPvAvg: { ja: '平均PV/d', en: 'PV / day μ', fr: 'PV/j μ' },
    analyticsHudRadarAuth: { ja: '認証24h', en: 'Auth Δ24', fr: 'Auth Δ24' },
    analyticsHudRadarAuthW: {
      ja: '認証7d',
      en: 'Week auth',
      fr: 'Connexions 7j',
    },
    analyticsHudRadarMean: { ja: '基線PV', en: 'Baseline PV', fr: 'Base PV' },
    analyticsHudRadarPeak: {
      ja: 'ピーク日',
      en: 'Peak day',
      fr: 'Journée pic',
    },
    analyticsHudPanelTargets: {
      ja: '24hウェイトゲージ',
      en: '24h weight gauges',
      fr: 'Jauges pondération 24h',
    },
    analyticsHudPanelTargetsSub: {
      ja: '週間ボリュームに占める当日割合。',
      en: 'Share of rolling week captured in latest day.',
      fr: 'Part de la fenêtre glissante captée en une journée.',
    },
    analyticsHudGaugePvShare: {
      ja: 'PV構成比',
      en: 'Traffic share',
      fr: 'Part trafic',
    },
    analyticsHudGaugeAuthShare: {
      ja: 'サインイン構成',
      en: 'Sign-in mix',
      fr: 'Part connexion',
    },
    analyticsHudPanelIdentity: {
      ja: 'IDイベント対比',
      en: 'Sessions vs traces',
      fr: 'Sessions vs traces',
    },
    analyticsHudPanelIdentitySub: {
      ja: '認証カウントとページトレース。',
      en: 'Login counts juxtaposed against page pulses.',
      fr: 'Connexions projetées contre les pulsations PV.',
    },
    analyticsHudBarsLogins: { ja: 'ログイン', en: 'Logins', fr: 'Connexions' },
    analyticsHudBarsPv: {
      ja: 'PV同日',
      en: 'Daily PV',
      fr: 'PV/jour',
    },
    analyticsHudPanelHeat: {
      ja: 'ショートターム熱度',
      en: 'Near-term saturation',
      fr: 'Saturation court terme',
    },
    analyticsHudPanelHeatSub: {
      ja: '高密度稼働の速報インジケータ。',
      en: 'Fast indicator when both channels spike together.',
      fr: 'Signal rapide lorsque deux canaux explosent ensemble.',
    },
    analyticsHudHeatExplainer: {
      ja: '24h構成比の加重平均。上昇でトラフィックが日次に集中。',
      en: 'Blend of 24h / 7d ratios. Higher means energy concentrated in the latest day.',
      fr: 'Mélange des ratios 24h / 7j. Plus haut = énergie concentrée sur la dernière journée.',
    },
    analyticsHudPanelSpark: {
      ja: 'ターミナル棒比較',
      en: 'Terminal bar compare',
      fr: 'Barres comparatives',
    },
    analyticsHudPanelSparkSub: {
      ja: '主要KPIの即時スナップショット。',
      en: 'Snapshot of headline counters for the watch floor.',
      fr: 'Instantané des compteurs clés pour la salle de contrôle.',
    },
    analyticsHudWideTitle: {
      ja: '統合タイムライン監督',
      en: 'Unified supervision runway',
      fr: 'Piste de supervision unifiée',
    },
    analyticsHudWideSub: {
      ja: '日別PVと同日ログインフロー。',
      en: 'Page volume bars with overlapping login flow.',
      fr: 'Barres de volumes avec flux de connexions superposées.',
    },
    analyticsHudLineLogins: { ja: 'ログイン曲線', en: 'Login flow', fr: 'Flux connex.' },
    analyticsHudNoLogins: {
      ja: 'このウィンドウにログインレコードはありません。',
      en: 'No captured sign-ins yet for this window.',
      fr: 'Aucune connexion récente sur cette fenêtre.',
    },

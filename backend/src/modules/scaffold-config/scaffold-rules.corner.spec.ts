...
describe('fitSpansToWallLengthWithCorner (kusabi)', () => {
  it('uses 1800 first and 600 last; exact total when middle is an exact span sum (e.g. 10,200mm wall)', () => {
    const wallMm = 10_200;
  ...
  it('exact two-span layout when wallLength = 2100mm', () => {
...
describe('fitSpansToWallLengthWithCornerWakugumi', () => {
  it('uses 1829 first and 610 last; total run >= wall+300 (discrete spans may add small overrun)', () => {
    const wallMm = 10_000;

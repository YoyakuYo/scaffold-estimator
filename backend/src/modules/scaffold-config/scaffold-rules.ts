 ...
 *   The middle is filled from **SPAN_SIZES** (may overrun when **wall+300−1829** is not an exact sum of modules —
 *   many façade lengths are not in the semigroup generated by the catalog). Adjacent middle bays whose lengths
